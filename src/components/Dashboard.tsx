...
import { createTodo, deleteOneTodo, deleteTodos, getTodos, updateTodo } from "../api/todos";
...
export const Dashboard: React.FC = () => {
	...
	const handleConfirmSelect = () => {
		...
		setRealTimeUpdate((prev) => !prev); // condition de si real time est a true on passe a false et vice versa
		setOpenDelete(false);
												...
												todosSliced.map((todo, key) => (
													<>
														...
														<Dialog open={openEdit}>
															...
															<DialogContent className="sm:max-w-[425px] text-darky dark:text-lighty">
																<DialogHeader>
																	<DialogTitle>Modifier un Todo</DialogTitle>
																	<DialogDescription>Modifiez le titre ou le statut de votre Todo</DialogDescription>
																</DialogHeader>
														...
														<Dialog open={openDeleteSelect}>
															...
															<DialogContent className="sm:max-w-[425px] text-darky dark:text-lighty">
																<DialogHeader>
																	<DialogTitle>Supprimer plusieurs taches ?</DialogTitle>
																	<DialogDescription>Attention, cette action est irreversible. Voulez-vous vraiment supprimer plusieurs taches ?</DialogDescription>
																</DialogHeader>
																<DialogFooter>
																	<Button type="submit" onClick={() => handleConfirmSelect()} className="w-full" variant={"destructive"}>
																		Supprimer
