...
export const Dashboard: React.FC = () => {
  ...
  const [todosFiltered, setTodosFiltered] = useState<Array<Todos>>([]);
            ...
            <DialogContent className="sm:max-w-[425px] text-darky dark:text-lighty">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input id="name" placeholder="Acheter du pain, Appeler Marc ..." className="col-span-3" onChange={(e) => setNewTodo((prev) => ({ ...prev, title: e.target.value, userID: user.id }))} />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
